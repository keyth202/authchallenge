...
function gateKeeper(req, res, next) {
  ...
  var credentials = queryString.parse(req.get('x-username-and-password'));
  var user = credentials.user;
  var pass = credentials.pass
  
  // Should give credentials.user and credentials.pass

    req.user = USERS.find((username, index)=> username.userName === user && username.password === pass);
